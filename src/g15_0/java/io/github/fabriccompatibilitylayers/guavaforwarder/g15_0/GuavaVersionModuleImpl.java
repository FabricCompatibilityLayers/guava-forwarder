...
public class GuavaVersionModuleImpl implements GuavaVersionModule {
    ...
    public void registerVisitors(VisitorInfos visitorInfos, GuavaVersion fromVersion, GuavaVersion toVersion) {
        ...
        // C_GenericMapMaker#makeComputingMap takes a leading GenericMapMaker parameter (to
        // match the original member's descriptor) - GenericMapMaker itself was removed in
        // Guava 20.0, so once the actual runtime Guava is that new, no mod bytecode could
        // hold a GenericMapMaker instance to call this with anyway, and reflecting over the
